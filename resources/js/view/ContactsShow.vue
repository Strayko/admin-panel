  ...
  <div v-else>
    <div class="flex justify-between">
      ...
      <div class="relative">
        ...
        <div v-if="modal" class="absolute bg-blue-900 text-white rounded-lg z-20 p-8 w-64 right-0 mt-4">
      ...
      <div @click="modal = ! modal" v-if="modal" class="bg-black opacity-25 absolute right-0 left-0 top-0 bottom-0 z-10">
      </div>
    </div>

        ...
        <h2 class="text-blue-300">Enter your information below</h2>
            ...
            <form method="POST" action="{{ route('register') }}" class="pt-8">
                  ...
                  <div class="relative">
                      ...
                      <div>
                          <input id="name" type="text" class="pt-8 w-full rounded p-3 bg-blue-800 text-green-100 outline-none focus:bg-blue-700" name="name" value="{{ old('name') }}" placeholder="Enter your name" autocomplete="name" autofocus>
                  ...
                  <div class="relative pt-3">
                      ...
                      <div>
                          <input id="email" type="email" class="pt-8 w-full rounded p-3 bg-blue-800 text-green-100 outline-none focus:bg-blue-700" placeholder="Enter your email" name="email" value="{{ old('email') }}" autocomplete="email">
                  ...
                  <div class="relative pt-3">
                      ...
                      <div>
                          <input id="password" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-green-100 outline-none focus:bg-blue-700" placeholder="Password" name="password" autocomplete="new-password">
                  ...
                  <div class="relative pt-3">
                      ...
                      <div>
                          <input id="password-confirm" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-green-100 outline-none focus:bg-blue-700" placeholder="Confirm password" name="password_confirmation" autocomplete="new-password">
                      </div>
                  </div>
